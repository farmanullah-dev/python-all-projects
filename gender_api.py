    ...
    try:
        ...
        if "gender" in data and data["gender"]:
            ...
            result_label.config(
                ...
                fg="#FACC15" if gender == "Female" else "#60A5FA",
            )
        else:
            result_label.config(text="❌ Gender not found for this name.", fg="#F87171")
...
# --- GUI Setup ---
root = tk.Tk()
root.title("⚧ Gender Predictor (Genderize.io)")
root.geometry("500x450")
root.config(bg="#0F172A")

# --- Title ---
lbl_title = tk.Label(
    root, text="⚧ Gender Predictor", font=("Segoe UI", 22, "bold"), fg="#38BDF8", bg="#0F172A"
)
...
btn_predict = tk.Button(
    frame, text="Predict", font=("Segoe UI", 13, "bold"), bg="#38BDF8", fg="white", relief=tk.FLAT, command=predict_gender
)
...
# --- Footer ---
lbl_footer = tk.Label(
    root, text="🔗 Powered by Genderize.io API", font=("Segoe UI", 10), fg="#94A3B8", bg="#0F172A"
)
